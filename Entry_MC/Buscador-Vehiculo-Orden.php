                            ...
                            <div class="row">
                                ...
                                <div class="col-10 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value=<?php echo $fila['Codigo'] ?> required class="form-control"
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value=<?php echo $fila['Placa'] ?> required class="form-control"
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value=<?php echo $fila['Marca'] ?> required class="form-control"
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value=<?php echo $fila['Modelo'] ?> required class="form-control"
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        <label for="Tipo_Mantenimiento" class="bmd-label-floating">TipoMantenimiento</label>
                                ...
                                <div class="col-12 col-md-7">
                                    <div class="form-group">
                                        <label for="Fecha_Orden_Trabajo" class="bmd-label-floating">Fecha Entrada</label>
