						...
						<div class="row">
							<div class="col-10 col-md-7">
								<div class="form-group">
									...
									<input class="form-control form-control-sm" type="text" name="Id_Registro_Salida"
										id="Id_Registro_Salida" placeholder="El Codigo es Asignado por el Sistema"
							...
							<div class="col-12 col-md-7">
								<div class="form-group">
									...
									<input type="datetime-local" id="Fecha_Registro_Salida" name="Fecha_Registro_Salida"
